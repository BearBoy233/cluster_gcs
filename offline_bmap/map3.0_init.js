 ...
 */
var bmapConfig = {
  'tiles_path'     : '../offline_tiles/tiles',      //显示普通地图，为空默认在 tiles/ 目录
  'tiles_satellite_path': '../offline_tiles/tiles_satellite', //显示卫星影像，为空默认在 tiles_satellite/ ，只有底图没有地址标注
  'tiles_hybrid_path'   : '../offline_tiles/tiles_hybird'  //显示带有街道的卫星影像，为空默认在 tiles_hybrid/，需和卫星影像配合使用
};
